...
export default function Home() {
  ...
  const [showDeportationQuestion, setShowDeportationQuestion] = useState(false);
  ...
  const handleStart = () => {
    ...
    setShowDeportationQuestion(false);
  ...
  const handleNext = () => {
    // Calculate points for this vignette
    const points =
    ...
    if (currentIndex < vignettes.length - 1) {
      ...
      // Quiz finished - submit responses
  ...
  if (quizFinished) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-12 px-4 font-sans">
